...
severity: "medium"
status: "Closed"
category: "Malware Analysis / Stealer"
threat_actor: "Unknown (script kiddie)"
confidence: "High"
tlp: "WHITE"
tags: ["stealer", "Python", "Discord", "DPAPI", "webhook", "Roblox"]
mitre: ["T1555", "T1539", "T1082"]
iocs:
  - { type: "Hash", value: "b8d1c0436023bf58ea7b0f530ea37ae67bac0e956d9c93376702b4832055e0fd", description: "SHA256 of Phantom X.exe" }
  - { type: "File", value: "Phantom X.exe", description: "Distributed stealer binary" }
timeline:
  - { time: "Jun 8, 2024", action: "Sample acquired", detail: "RedTiger stealer sample obtained for analysis" }
  - { time: "Jun 9, 2024", action: "Deobfuscation complete", detail: "Python source recovered and capabilities mapped" }
  - { time: "Jun 10, 2024", action: "Case closed", detail: "Low sophistication (3.1/10), analysis published" }
related_cases: ["blankgrabber"]
---
...
![](/images/redtiger/Pasted-image-20250629181942.png)

![](/images/redtiger/Pasted-image-20250629181954.png)

![](/images/redtiger/Pasted-image-20250629182007.png)
