...
confidence: "High"
tlp: "WHITE"
tags: ["stealer", "PyInstaller", "BlankOBF", "anti-VM", "Discord", "crypto"]
mitre: ["T1055", "T1497", "T1005", "T1125"]
iocs:
  - { type: "Hash", value: "94237eac80fd2a20880180cab19b94e8760f0d1f06715ff42a6f60aef84f4adf", description: "SHA256 of Velocity.exe" }
  - { type: "Hash", value: "8073f87f61f0625f1ec5ecc24c1c686e", description: "MD5 of Velocity.exe" }
  - { type: "File", value: "Velocity.exe", description: "PyInstaller-packed stealer" }
  - { type: "File", value: "blank.aes", description: "Encrypted payload stage" }
timeline:
  - { time: "May 19, 2024", action: "Sample discovered on tria.ge", detail: "Velocity.exe found in public dynamic analysis sandbox" }
  - { time: "May 20, 2024", action: "Unpacking chain resolved", detail: "5-layer obfuscation chain fully unwrapped" }
  - { time: "May 21, 2024", action: "Anti-analysis mapped", detail: "VM/sandbox detection and evasion techniques documented" }
  - { time: "May 22, 2024", action: "Case closed", detail: "Capabilities documented, sophistication 3/10" }
related_cases: ["redtiger-stealer"]
---
...
![](/images/blankgrabber/Pasted-image-20250629181132.png)
...
![](/images/blankgrabber/Pasted-image-20250629181146.png)
...
![](/images/blankgrabber/Pasted-image-20250629181204.png)

If we scroll a bit lower we see UnpacMe has extracted quite a few files for us and it's even provided us with a brief overview of what the files do. It also allows us to download each extracted file.
![](/images/blankgrabber/Pasted-image-20250629181217.png)
![](/images/blankgrabber/Pasted-image-20250629181231.png)
...
![](/images/blankgrabber/Pasted-image-20250629180617.png)
...
![](/images/blankgrabber/Pasted-image-20250629181304.png)
...
![](/images/blankgrabber/Pasted-image-20250629181336.png)

First thing I noticed is the C2 b64 encoded string.
![](/images/blankgrabber/Pasted-image-20250629180546.png)
...
![](/images/blankgrabber/Pasted-image-20250629181348.png)
...
![](/images/blankgrabber/Pasted-image-20250629180519.png)
...
![](/images/blankgrabber/Pasted-image-20250629180445.png)
...
![](/images/blankgrabber/Pasted-image-20250629180320.png)
![](/images/blankgrabber/Pasted-image-20250629180303.png)
![](/images/blankgrabber/Pasted-image-20250629180230.png)
![](/images/blankgrabber/Pasted-image-20250629180206.png)

Interestingly, it seems to block AV websites specifically to try and prevent the user from remediating the infection.
![](/images/blankgrabber/Pasted-image-20250629180145.png)
...
![](/images/blankgrabber/Pasted-image-20250629180129.png)
### Browsers
...
![](/images/blankgrabber/Pasted-image-20250629180112.png)
...
![](/images/blankgrabber/Pasted-image-20250629180054.png)
...
![](/images/blankgrabber/Pasted-image-20250629180036.png)
...
![](/images/blankgrabber/Pasted-image-20250629180020.png)
...
![](/images/blankgrabber/Pasted-image-20250629175942.png)
