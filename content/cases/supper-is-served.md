...
severity: "critical"
status: "Closed"
category: "Malware Analysis / RAT"
threat_actor: "Vanilla Tempest / Vice Society"
confidence: "High"
tlp: "WHITE"
tags: ["RE", "RAT", "C2", "backdoor", "YARA", "Vanilla Tempest", "fileless"]
mitre: ["T1059", "T1071", "T1140", "T1573"]
iocs:
  - { type: "IP", value: "64.94.84.85", description: "C2 server" }
  - { type: "IP", value: "49.12.69.80", description: "C2 server" }
  - { type: "IP", value: "96.62.214.11", description: "C2 server" }
  - { type: "File", value: "socks.dll", description: "Original DLL name" }
  - { type: "Hash", value: "61f8224108602eb1f74cb525731c9937c2ffd9a7654cb0257624507c0fdb5610", description: "Supper backdoor sample" }
timeline:
  - { time: "Aug 12, 2024 09:00", action: "Case opened", detail: "Sample acquired for analysis" }
  - { time: "Aug 12, 2024 14:30", action: "Static analysis complete", detail: "Identified as 176 KiB 64-bit PE DLL with single export" }
  - { time: "Aug 13, 2024 10:00", action: "C2 protocol reverse engineered", detail: "HTTPS + JSON communication with custom stream cipher" }
  - { time: "Aug 14, 2024 11:00", action: "Command table documented", detail: "Mapped all command handlers (0x0-0x9)" }
  - { time: "Aug 15, 2024 09:00", action: "YARA rule published", detail: "Detection rule based on functional signatures" }
  - { time: "Aug 15, 2024 12:00", action: "Case closed", detail: "Investigation published, IOCs shared with community" }
related_cases: ["install-linters-get-malware", "blankgrabber"]
---
